...
public class Tileset {
    ...
    public static final TETile PLAYER = new TETile('@', Color.BLUE, new Color(0, 100, 200), "player", 13);
    public static final TETile MONSTER = new TETile('/', Color.RED, new Color(125, 0, 0), "monster", 14);
    public static final TETile MONSTERPATH = new TETile('*', new Color(200, 50, 50), Color.black, "floor", 15);
}
